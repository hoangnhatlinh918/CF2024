...
#make modules
git clone --depth 100 https://github.com/hoangnhatlinh918/CF2024.git
mkdir /etc/nginx/modules/
cp  /root/CF2024/ngx_http_modsecurity_module.so /etc/nginx/modules
...
/opt/splunkforwarder/bin/splunk add monitor -auth sc_admin:E5e5e5@52 /var/log/nginx/access.log
